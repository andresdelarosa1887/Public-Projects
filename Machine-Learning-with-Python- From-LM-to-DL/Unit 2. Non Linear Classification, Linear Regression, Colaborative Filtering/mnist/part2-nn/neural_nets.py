...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        output_layer_error = (activated_output -y) * relu_dev(hidden_to_output) 
        ...
        self.hidden_to_output_weights =  hidden_to_output_weights - (learning_rate*hidden_to_output_weights_gradients) 
    ...
    def predict(self, x1, x2):
        ...
        hidden_layer_weighted_input = np.dot(input_to_hidden_weights, input_values) + biases # TODO (3 by 1 matrix)
        hidden_layer_activation = relu(hidden_layer_weighted_input)  # TODO (3 by 1 matrix)
        output = np.dot(hidden_to_output_weights, hidden_layer_activation)  # TODO 1x1 
        activated_output = relu(output)  # TODO 1X1
